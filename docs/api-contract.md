# API Contract — Serverless Todo List (Phase 0, locked)

> **Status:** Locked as of 2026-07-18. This is the authoritative contract for Phases 1–6.
> Phases 1 (Lambda), 4 (Terraform/API Gateway/Cognito), and 5 (frontend) implement this document.
> Changes here require re-opening the affected phases, so it is deliberately fixed before code changes begin.
